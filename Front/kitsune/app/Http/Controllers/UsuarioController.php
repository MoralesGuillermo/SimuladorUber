...
class UsuarioController extends Controller
{
    ...
    public function crear(Request $request){
        try{
            ...
            $body = [
                ...
                $client = new Client();
                $response = $client->post('http://localhost:8082/kitsune/cliente/crear', [
    ...
    public function algo($clienteId){
            try {
                $client = new Client();
                
                $responseCliente = $client->get("http://localhost:8082/kitsune/cliente/perfil.$clienteId");
        ...
        public function perfil($clienteId){
            try {
                ...
                return view('perfil', compact('perfilcliente','clienteId'));
            } catch (RequestException $e) {
                return 'Error al mostrar el perfil del cliente'.$e->getMessage();
            }
