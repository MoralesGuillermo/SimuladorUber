...
<body style="background-color: #ffe6cd;">
    ...
    <div style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);background-color: white; border-radius: 10px; margin-top: 10%;margin-left: 33%; width:max-content; display: flex;justify-content: center; border-color: orange;">
        ...
        <form style="padding: 50px; padding-block: 20px;" method="POST" action='{{route('crearTarjeta')}}'>
            ...
            <input class="form-control" style="padding: 10px ; border-radius: 25px;" type="text" id="usuario" name="usuario" ><br>
    
            <label style="padding: 10px;color: rgb(248, 131, 6);;" for="pan">Pan:</label><br>
            <input class="form-control" style="padding: 10px;border-radius: 25px;" id="pan" name="pan" ><br>
    
            
            <label style="padding: 10px;color: rgb(248, 131, 6);;" for="fechaCaducidad">Fecha caducidad</label><br>
            <input class="form-control" style="padding: 10px;border-radius: 25px;" id="fechaCaducidad" name="fechaCaducidad" ><br>

            <label style="padding: 10px;color: rgb(248, 131, 6);;" for="cvv">CVV:</label><br>
            <input type="number" class="form-control" style="padding: 10px;border-radius: 25px;" id="cvv" name="cvv" ><br>

            <label style="padding: 10px;color: rgb(248, 131, 6);;" for="metodoPago">Metodo de Pago:</label><br>
            <input class="form-control" style="padding: 10px;border-radius: 25px;" id="metodoPago" name="metodoPago" ><br>

            <div class="buttons" style="padding: 10px">
                <button class="btn" style="background-color: #ffe6cd;border-color: rgb(159, 152, 145);">Cancelar</button>
